  ...
  async function onSubmit(values: z.infer<typeof AppointmentFormValidation>) {
    ...
    try {
      if (type === 'create' && patientId) {
        ...
        console.log("Submitting appointment data:", appointmentData); // Debugging log
        const appointment = await createAppointment(appointmentData);
      
        if (!appointment) {
          console.error("Appointment creation failed");
          return; // Stop further execution if the appointment is null
        }

        console.log("Appointment created, navigating to success page...");
        form.reset();
